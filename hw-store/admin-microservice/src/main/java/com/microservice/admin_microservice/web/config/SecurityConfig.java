    ...
    SecurityFilterChain filterChain(HttpSecurity http) throws Exception{
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/v1/**").hasAnyAuthority("ADMIN")
                        .requestMatchers(HttpMethod.POST, "/v1/**").hasAnyAuthority("ADMIN")
                        .requestMatchers(HttpMethod.PUT, "/v1/**").hasAnyAuthority("ADMIN")
