...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        if (requestUri.endsWith("/v1/auth/authenticate") || requestUri.endsWith("/v1/auth/test") || requestUri.endsWith("/v1/auth/isLoggings") ||
                requestUri.startsWith("/hardware-store/api/swagger-ui.html") || requestUri.startsWith("/hardware-store/api/swagger-ui") ||
